...
import io.claude.my_todo.util.MongoOffsetDateTimeReader;
import io.claude.my_todo.util.MongoOffsetDateTimeWriter;
...
@Configuration
@EnableMongoRepositories("io.claude.my_todo")
